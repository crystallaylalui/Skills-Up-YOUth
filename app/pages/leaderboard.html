...
<body>
    <article class="leaderboard">
        <header>
          ...
          <h1 class="leaderboard__title"><span class="leaderboard__title--top">Badges</span><span class="leaderboard__title--bottom">Leaderboard</span></h1>
        </header>
        ...
        <main class="leaderboard__profiles">
          <article class="leaderboard__profile">
            ...
            <span class="leaderboard__value">36<span>Badges</span></span>
          </article>
          
          <article class="leaderboard__profile">
            <img src="https://randomuser.me/api/portraits/men/97.jpg" alt="Jeff Bezos" class="leaderboard__picture">
            <span class="leaderboard__name">Jeff Bezos</span>
            <span class="leaderboard__value">20<span>Badges</span></span>
          </article>
          
          <article class="leaderboard__profile">
            <img src="https://randomuser.me/api/portraits/women/17.jpg" alt="Elon Musk" class="leaderboard__picture">
            <span class="leaderboard__name">Elon Musk</span>
            <span class="leaderboard__value">16<span>Badges</span></span>
          </article>
          
          <article class="leaderboard__profile">
            <img src="https://randomuser.me/api/portraits/men/37.jpg" alt="Bill Gates" class="leaderboard__picture">
            <span class="leaderboard__name">Bill Gates</span>
            <span class="leaderboard__value">12<span>Badges</span></span>
          </article>
        </main>
      </div>
</body>
